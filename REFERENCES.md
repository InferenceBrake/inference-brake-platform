...
| Dataset | Use | Link |
|---|---|---|
| PatronusAI/TRAIL | Agent debug traces, hallucination labels | <https://huggingface.co/datasets/PatronusAI/TRAIL> |
| princeton-nlp/SWE-bench_Verified | Software engineering agent tasks (synthetic traces) | <https://huggingface.co/datasets/princeton-nlp/SWE-bench_Verified> |
| McGill-NLP/agent-reward-bench | Eval metadata only - not used for loop detection | <https://huggingface.co/datasets/McGill-NLP/agent-reward-bench> |
| AmineHA/WebArena-Verified | Task definitions only - not used for loop detection | <https://huggingface.co/datasets/AmineHA/WebArena-Verified> |
